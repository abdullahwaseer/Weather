...
class SearchWeatherVC: UIViewController {
    ...
    private func setupTableView() {
        searchTableView.register(nib: SearchListTVCell.self)
...
extension SearchWeatherVC: UITableViewDelegate {
...
extension SearchWeatherVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: SearchListTVCell = searchTableView.dequeueReusableCell(forIndexPath: indexPath)
        if viewModel.isLoading {
...
extension SearchWeatherVC: EmptyStateDelegate {
